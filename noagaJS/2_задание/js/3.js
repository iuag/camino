...
let nameOfAnimal2 = 'Matilda';
nameOfAnimal2 = nameOfAnimal1;
console.log(nameOfAnimal2, typeof nameOfAnimal2);

const bestProgrammingLanguage1 = 'YoptaScript';
const bestProgrammingLanguage2 = 'Scratch';
console.log("Переменную const переопределить нельзя, 1 - ", bestProgrammingLanguage1, "2 - ", bestProgrammingLanguage2);
